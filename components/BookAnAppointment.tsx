  ...
  return (
    ...
    >
      <div className="w-full lg:w-7/12 h-auto lg:h-96 bg-white rounded-2xl shadow-lg shadow-gray-300 flex flex-col lg:flex-row justify-between items-center gap-4 p-4">
        <div className="bg-[url('/pic4.jpg')] w-full lg:w-6/12 h-44 lg:h-full bg-center bg-cover rounded-2xl"></div>
      ...
      <div className="w-full lg:w-5/12 h-96 bg-[url('/pic3.jpg')] bg-center bg-cover rounded-2xl flex justify-end items-start p-6">
