  ...
  return (
    <div>
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        <SwiperSlide>
          <div className="bg-[url('/pic32.jpg')] bg-center bg-contain lg:min-h-screen w-full flex flex-col justify-start items-start pt-36 lg:pt-56 pb-8 lg:pb-0">
            <div
        ...
        <SwiperSlide>
          <div className="bg-[url('/pic28.jpg')] bg-center bg-cover lg:min-h-screen w-full flex flex-col justify-start items-start pt-36 lg:pt-56 pb-8 lg:pb-0">
            <div
              className="px-2 lg:px-12 xl:px-36 flex flex-col justify-start items-start w-full"
              data-aos="fade-left"
            >
